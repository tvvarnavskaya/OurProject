...
public class SampleServer3 {
    ...
    public static void main(String[] args) {
        SampleServer3 s = new SampleServer3();
        s.listenSocket();
    }
    ...
    public void listenSocket(){
        ...
        while(true){
            try{
                ...
                String roomNumber = clientArgs[2];
                ...
                ServerSender serverSender = new ServerSender(userName, roomNumber, socket);
